    ...
    projects: [
      {
        ...
        sprints: [
          { id: 's1', name: 'Sprint 1: Setup & Foundations', startDate: '2026-02-01', endDate: '2026-02-14', status: 'Done', progress: 100, stages: ['Research', 'Design', 'Development'] },
          { id: 's2', name: 'Sprint 2: Product Catalog', startDate: '2026-02-15', endDate: '2026-02-28', status: 'Done', progress: 100, stages: ['Development', 'Testing'] },
          { id: 's3', name: 'Sprint 3: Checkout Flow', startDate: '2026-03-01', endDate: '2026-03-14', status: 'Review', progress: 95, stages: ['Development', 'Testing', 'Delivery'] },
          { id: 's4', name: 'Sprint 4: User Accounts', startDate: '2026-03-15', endDate: '2026-03-28', status: 'In Progress', progress: 40, stages: ['Development', 'Testing'] },
          { id: 's5', name: 'Sprint 5: Polishing & Testing', startDate: '2026-03-29', endDate: '2026-04-11', status: 'To Do', progress: 0, stages: ['Testing', 'Delivery'] },
          { id: 's6', name: 'Sprint 6: Performance & Scale', startDate: '2026-04-12', endDate: '2026-04-25', status: 'To Do', progress: 0, stages: ['Development', 'Testing'] },
          { id: 's7', name: 'Sprint 7: Final QA & Security', startDate: '2026-04-26', endDate: '2026-05-09', status: 'To Do', progress: 0, stages: ['Testing', 'Delivery'] },
