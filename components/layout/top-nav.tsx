  ...
  return (
    <header className="flex h-16 w-full items-center px-4 md:px-8 bg-transparent border-b border-white/[0.04]">
      ...
      <div className="flex items-center gap-2 ml-4">
        <button onClick={() => router.push('/dashboard/updates')} className="relative p-2.5 rounded-xl text-gray-400 hover:text-white hover:bg-white/[0.06] transition-colors cursor-pointer">
